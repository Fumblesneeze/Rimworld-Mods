...
- Add focused host tests, isolated finalized-loader checks, native construction/pathing/placement E2E workflows, and isolated Gateway-based native acceptance evidence.
