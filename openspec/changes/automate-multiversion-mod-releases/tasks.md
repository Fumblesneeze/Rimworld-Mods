...
- [ ] 13.5 PRESENTATION: TDD the player-facing Workshop copy, five-or-more reviewed visual feature assets, final `Author's Note`, exact Steam byte/tag policy, additional-preview URL inventory, and private-first creation policy; update the reusable release and asset skills with the proven workflow.
