...
- [ ] 13.6 WORKSHOP UPDATE: synchronize the reviewed feature images to item `3782589902`, publish the final illustrated description without changing its retained identity, inspect the live page and remote image rendering, then subscribe/reacquire and run the exact 1.6 smoke gate on the reviewed update.
