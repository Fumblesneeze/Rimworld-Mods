...
Cookware becomes dirty only after at least one actual cooking tick. Plates remain embedded per serving until ingestion, rot-to-nonmeal transformation, or explicit recovery. Silverware is acquired by the eater or Gastronomy server and becomes dirty after eating.
