...
- **THEN** that meal contains a real clean ungraded plate using the least-luxurious admissible service class and then the cheapest registered material within that class
