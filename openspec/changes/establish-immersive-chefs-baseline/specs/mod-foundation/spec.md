...
The build SHALL produce a RimWorld 1.6 mod package named Immersive Chefs with package ID `fumblesneeze.immersivechefs`, a generated `About/About.xml`, and its game assembly under `1.6/Assemblies`.
