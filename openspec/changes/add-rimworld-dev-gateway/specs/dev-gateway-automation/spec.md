...
- **THEN** the retained observation records the requested style, the observed mismatch, a nonfatal classification, and diagnostic detail while the healthy run continues through normal verification and cleanup
