...
- [x] 26.5 TDD/LAUNCH: Treat the exact-PID window-state observation as diagnostic after launch, so a user restore or maximize does not terminate an otherwise healthy isolated run; retain the requested style and observed mismatch in evidence.
