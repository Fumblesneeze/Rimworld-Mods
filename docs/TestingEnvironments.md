...
The accepted current-binary dispenser examples are `artifacts/EndToEndRuns/Grouped/20260806T054052469Z` for Replimat and `artifacts/EndToEndRuns/Grouped/20260806T044417918Z` for Meal Printer. The Replimat group includes both the successful lifecycle and a real failed-dispense race: two ordinary hungry diners reserve exact clean settings against one Ramen-scale feedstock serving, the nearer pawn visibly carries the sole native Ramen, and the rejected pawn's same plate and cutlery visibly return clean. Its checkpoint records feedstock `0.5 -> 0.0327103138` for the first serving and no further loss for the rejection. The acting agent also inspected the retained successful Ramen/Fine-meal carry and ingestion, exact dirty returned steel ware, and a NutriBar leaving clean golden decoys untouched. Matching loaded-main-menu shape/owner evidence remains `artifacts/GatewaySmoke/20260806T044058758Z` and `artifacts/GatewaySmoke/20260806T044157403Z`.
