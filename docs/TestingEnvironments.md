...
The accepted current-binary dispenser examples are `artifacts/EndToEndRuns/Grouped/20260806T061201358Z` for Replimat and `artifacts/EndToEndRuns/Grouped/20260806T044417918Z` for Meal Printer. The four-test Replimat process includes the successful lifecycle, a real failed-dispense race, native animal feeding, and native survival batching. Two ordinary hungry diners reserve exact clean settings against one Ramen-scale feedstock serving; the nearer pawn visibly carries the sole native Ramen, while the rejected pawn's same plate and cutlery visibly return clean with no second feedstock loss. A raccoon then visibly consumes the feeder's native loose Kibble while adjacent steel plate/cutlery controls remain clean. Finally, the ordinary terminal gizmo opens Replimat's real batch-survival-meal dialog and creates one selected Packaged survival meal while adjacent golden controls remain clean. The acting agent inspected every retained ordinary inspector/dialog frame. Matching loaded-main-menu identity, shape, exclusion, and Harmony-ownership evidence is `artifacts/GatewaySmoke/20260806T061059475Z`; the Meal Printer matrix remains `artifacts/GatewaySmoke/20260806T044157403Z`. The Replimat process launched minimized and used no focus, restore, resize, maximize, mouse, or keyboard action.
