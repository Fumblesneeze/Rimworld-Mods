...
The current OpenSpec also defines exact-package compatibility work for Adaptive Meal Bill, Meals on Wheels, Replimat Meals, the Vanilla Cooking Expanded family, Fried/Fast Meals, Food Texture Variety, Prioritize Meals over Preserved Foods, RimCuisine 2, Meal Printer, RimFridge, Overcooked Meals, and No Vanilla Meals. The RimCuisine/No-Vanilla registry, guarded Adaptive Meal Bill/Overcooked Meals final-product adapters, and the Fast Meals/Meals on Wheels/Prioritize food-selection group are implemented and proven in exact loaded-mod integration plus native cooking, dining, incident, and trade E2E workflows. Other integrations are not considered implemented until their guarded tests and native observable E2E matrix pass.
