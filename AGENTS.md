...
3. **Regression and package checks:** Run the focused test, owning suite, guarded repository suite, Release build, and package inspection. Run `openspec validate --all --strict --no-interactive` for specification changes.
